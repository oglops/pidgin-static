...
cd $BUILD_DIR
../fetchurl "http://downloads.sourceforge.net/project/pidgin/Pidgin/2.10.11/pidgin-2.10.11.tar.bz2"
...
../fetchurl "http://dist.schmorp.de/libev/libev-4.20.tar.gz"
...
make install #DESTDIR=/home/oglop/apps/pidgin
...
git checkout dev
# 
sed -i.bak '/\#include <curl\/types.h>/ s/^#*/\/\//' /home/oglop/Downloads/pidgin-static/build/pidgin-sendscreenshot/src/main.h
./configure #--prefix=$TARGET_DIR
make
make install
